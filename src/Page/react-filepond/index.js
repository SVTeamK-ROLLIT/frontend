...
const _filepond = require('filepond');
...
const isSupported = (0, _filepond.supported)();
...
const FilePond = (exports.FilePond = (function (_React$Component) {
  ...
  function FilePond(props) {
    ...
    const _this = _possibleConstructorReturn(
      this,
      (FilePond.__proto__ || Object.getPrototypeOf(FilePond)).call(this, props),
    );
  ...
  _createClass(FilePond, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        const { allowMultiple } = _props;
        const { required } = _props;
        const { captureMethod } = _props;
        const { acceptedFileTypes } = _props;
